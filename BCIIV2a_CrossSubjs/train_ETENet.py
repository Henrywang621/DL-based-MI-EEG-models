...
for i in range(5):
    ...
    model = create_raw_model(chans, nclasses, trial_length=720, l1=0)
    weights_path = "Checkpoints/ETENet-{0}.hdf5".format(i+1)
    ...
    model = load_model('Checkpoints/ETENet-{0}.hdf5'.format(i+1))
...
np.save('Checkpoints/results_ETENet.npy', results)
