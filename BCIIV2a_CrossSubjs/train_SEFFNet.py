...
for i in range(5):
    ...
    model=TS_SEFFNet(in_chans,n_classes)
    if cuda:
        model.cuda()
    weights_path = "Checkpoints/TS_SEFFNet-{0}.hdf5".format(i)
...
np.save('Checkpoints/results_SEFFNet.npy', results)
print("Done!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")  
