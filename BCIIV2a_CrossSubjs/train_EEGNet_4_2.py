...
for i in range(5):
    ...
    model = EEGNet(nb_classes = n_classes, Chans = 22, 
                   dropoutRate = 0.5, kernLength = 64, F1 = 4, D = 2, F2 = 16, 
                   dropoutType = 'Dropout')
    weights_path = "Checkpoints/EEGNet_4_2-{0}.hdf5".format(i+1)
    ...
    model = load_model('Checkpoints/EEGNet_4_2-{0}.hdf5'.format(i+1))
...
np.save('Checkpoints/results_EEGNet_4_2.npy', results)
